...
use Craue\FormFlowBundle\FormFlow\Step;
...
class StepTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCreateFromConfig() {
		$flowStub = $this->getMock('\Craue\FormFlowBundle\FormFlow\FormFlowInterface');
		...
		$flowStubWithData = $this->getMock('\Craue\FormFlowBundle\FormFlow\FormFlowInterface');
		$flowStubWithData
			->expects($this->once())
			->method('getFormData')
	...
	public function testEvaluateSkipping_validReturnValueFromCallable($returnValue) {
		...
		$step->evaluateSkipping(1, $this->getMock('\Craue\FormFlowBundle\FormFlow\FormFlowInterface'));
