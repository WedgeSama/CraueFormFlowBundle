...
class FormFlowTest extends \PHPUnit_Framework_TestCase {
	...
	public function testStepListener() {
		$steps = array(
			$this->getMock('\Craue\FormFlowBundle\FormFlow\StepInterface'),
		);
		...
		/* @var $flow \PHPUnit_Framework_MockObject_MockObject|\Craue\FormFlowBundle\FormFlow\FormFlow */
		$flow = $this->getMockForAbstractClass('\Craue\FormFlowBundle\FormFlow\FormFlow');
	...
	public function testCreateStepsFromConfig_fixArrayIndexes() {
		$flowStub = $this->getMock('\Craue\FormFlowBundle\FormFlow\FormFlow', array('getName', 'loadStepsConfig'));
	...
	public function testGetRequestedStepNumber($httpMethod, $parameters, $dsnEnabled, $expectedStepNumber) {
		$flow = $this->getMock('\Craue\FormFlowBundle\FormFlow\FormFlow', array('getName', 'getRequest'));
	...
	public function testSetGetStorage() {
		...
		$storage = $this->getMock('\Craue\FormFlowBundle\FormFlow\Storage\StorageInterface');
	 ...
	 * @expectedException \Craue\FormFlowBundle\FormFlow\Exception\InvalidTypeException
	 */
